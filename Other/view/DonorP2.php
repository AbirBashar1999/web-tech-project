...
<html>
    <head>
        <title>BBN | Submission Successful</title>
    ...
    <body style="background-color: ghostwhite;">
        ...
        <h2 align="center">Thanks for your Submission!</h2>
        <p align="center">Please wait for Donation Request and be prepare for donation. You will get Donation request soon.</p>
